...
const Card = (props) => {
  return (
    <div className="card" style={{padding: "50px"}}>
      <img src={props.imageUrl} alt={props.imageAlt} style={{borderRadius: "20px", border: "solid", borderColor: "#ABDCD6", display: "block", margin: "0 auto", borderWidth: "10px", maxWidth: "30%"}} />
